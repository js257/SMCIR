...
from .way.c_model import MultiModalAttentionFusion
...
class BertEncoder(nn.Module):
    def __init__(self, config, args=None):
        ...
        self.SMCIR = MultiModalAttentionFusion(args)
    ...
    def forward(self, hidden_states, visual=None, acoustic=None, visual_ids=None, acoustic_ids=None,
        ...
        hidden_states,sim_loss = self.SMCIR(hidden_states, visual, acoustic)


        return hidden_states,sim_loss  # last-layer hidden state, (all hidden states), (all attentions)
...
class SMCIR(BertPreTrainedModel):
    config_class = BertConfig
    pretrained_model_archive_map = BERT_PRETRAINED_MODEL_ARCHIVE_MAP
    base_model_prefix = "bert"

    def __init__(self, config, pos_tag_embedding=False, senti_embedding=False, polarity_embedding=False, args=None):
        super(SMCIR, self).__init__(config)
    ...
    def forward(self, text, acoustic, visual, visual_ids=None, acoustic_ids=None, pos_tag_ids=None, senti_word_ids=None,
                polarity_ids=None, position_ids=None, head_mask=None, labels=None):
